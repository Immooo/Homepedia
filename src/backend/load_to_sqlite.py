...
"""
Création d'une base SQLite et chargement des données DVF et INSEE.
Produit un fichier SQLite : data/homepedia.db
Tables créées :
 - transactions
 - population
"""
...
# Conversion colonne valeur_fonciere
...
print("Table 'population' chargée.")
